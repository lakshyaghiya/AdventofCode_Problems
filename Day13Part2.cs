    ...
    static void Main()
    {
        ...
        for (int i = 0; i < input.Length; i = i + 4)
        {
            ...
            var coordinates = new Coordinates
            {
                ...
                Prize = (int.Parse(prizeParts[1]) + 10000000000000, int.Parse(prizeParts[2]) + 10000000000000)
            };
        ...
        foreach (var coord in coordinatesList)
        {
            ...
            long numY = (coord.ButtonA.Y * coord.Prize.X) - (coord.ButtonA.X * coord.Prize.Y);
            ...
            long numX = coord.Prize.X - (coord.ButtonB.X * y);
            if (numX % coord.ButtonA.X != 0)
                continue;

            long x = numX / coord.ButtonA.X;
